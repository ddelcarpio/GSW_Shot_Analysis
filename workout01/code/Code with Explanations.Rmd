...
Now lets take a look a closer look the shot locations of the warriors. By using x-y locations we plotted the location of every shot, with red dots indicating a missed shot, while the blue dots represent shots that were made. 

```{r out.width='80%', echo = FALSE, fig.align='center'}
knitr::include_graphics('C:/Users/danie/OneDrive/Documents/GitHub/stat133workout01/workout01/images/gsw-shot-charts.png')
```
